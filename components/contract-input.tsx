...
const CustomCodeEditor: React.FC<CustomCodeEditorProps> = ({
  ...
  return (
    <div className="relative lg:w-4/6 w-full mx-auto">
      ...
      <div className="absolute bottom-0 inset-x-0 p-4 rounded-b-md bg-white dark:bg-neutral-900">
        <div className="flex justify-center items-center">
          <button
            onClick={handleAnalyze}
            type="button"
            className="flex flex-row items-center space-x-2 px-6 py-1.5 justify-center rounded-full text-white bg-green-600 hover:bg-green-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <span>Audit</span>
